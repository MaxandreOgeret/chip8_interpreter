...
int main(int argc, char ** argv) {
  ...
  try {
    TCLAP::CmdLine cmd("CHIP8 Interpreter written in C++, "
                       ...
                       "https://github.com/MaxandreOgeret/chip8_interpreter", ' ', "0.1");
    ...
    TCLAP::SwitchArg conf_2_arg("2", "2",
                                ...
                                cmd, false);
    TCLAP::SwitchArg conf_1_arg("1", "1", "Shift instructions 8xy6 and 8xyE will also set xv to the value of xy.", cmd,
                                false);
    ...
    std::unique_ptr<Emulator> emulator = std::make_unique<Emulator>(configuration);
    emulator->loop();
